...
const logs = require('./logEvent')

// initialize object
class MyEmitter extends Emitter { };
const myEmitter = new MyEmitter()
myEmitter.on('log', (message, filename) => logs(message, filename))
...
const serveFile =  async(filePath, contentType, response) => {
  try {
    ...
    myEmitter.emit('log', `${err.name} : ${rerr.message}`, 'errLog.txt')
...
const server = http.createServer((req, res) => {
  ...
  // makes .html statement not required in the browser
